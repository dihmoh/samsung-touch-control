...
namespace TouchToggle
{
    public partial class MainForm : Form
    {
        ...
        private void LoadPanel()
        {
            ...
            string ariaChecked = _config.GetStartWithWindows() ? "true" : "false";
...
<div class='content-area'>
  <div class='card card-main'>
    <div class='ring-container'>
      <button class='btn-toggle' aria-label='{Strings.AccessibleToggle} - {statusText}' title='{Strings.AccessibleToggle}' onclick=""window.chrome.webview.postMessage('toggle')"">
        {touchIcon}
      </button>
    </div>
  ...
  <div class='card card-startup' role='switch' aria-checked='{ariaChecked}' tabindex='0' onclick=""window.chrome.webview.postMessage('startup')"" onkeydown=""if(event.key==='Enter'||event.key===' '){{event.preventDefault();window.chrome.webview.postMessage('startup');}}"">
    <div class='text-col'>
