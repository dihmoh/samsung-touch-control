...
<div class='content-area'>
  ...
  <div class='card card-startup' role='button' tabindex='0' aria-label=""{Strings.MenuStartup}"" onclick=""window.chrome.webview.postMessage('startup')"" onkeydown=""if(event.key==='Enter'||event.key===' '){{event.preventDefault();window.chrome.webview.postMessage('startup');}}"">
    <div class='text-col'>
