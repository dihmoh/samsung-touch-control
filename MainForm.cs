...
<style>
  * {{ margin: 0; padding: 0; box-sizing: border-box; user-select: none; }}
  ...
  .btn-toggle:focus-visible {{ outline: 2px solid white; outline-offset: 4px; }}
...
<div class='content-area'>
  <div class='card card-main'>
    ...
    <div class='hotkey-container' role='button' tabindex='0' onkeydown=""if(event.key==='Enter'||event.key===' ')window.chrome.webview.postMessage('change_hotkey')"" onclick=""window.chrome.webview.postMessage('change_hotkey')"">
      ⌨ {hotkeyText} ✏️
    </div>
  </div>

  <div class='card card-startup' role='button' tabindex='0' onkeydown=""if(event.key==='Enter'||event.key===' ')window.chrome.webview.postMessage('startup')"" onclick=""window.chrome.webview.postMessage('startup')"">
    <div class='text-col'>
